                        ...
                        children: 
                            <div className="grid grid-cols-1 gap-3 justify-between md:grid-cols-2">
                                <BulletList 
                                    ...
                                    bullets={['Event Hall']} 
                                />
                                <img src="/photos/tier-1.jpeg" alt="Package 1" className={imgClass} />
                            </div>
                    },
                    {
                        name: 'Tier 2',
                        ...
                        <div className="grid grid-cols-1 gap-3 justify-between md:grid-cols-2">
                            ...
                            />
                            <img src="/photos/tier-2.jpeg" alt="Package 2"  className={imgClass} />
                        </div>
                    },
                    {
                        name: 'Tier 3',
                        ...
                        <div className="grid grid-cols-1 gap-3 justify-between md:grid-cols-2">
                            ...
                            />
                            <img src="/photos/tier-3.jpeg" alt="Package 3"  className={imgClass} />
                        </div>                
                    }
                ]}
            />
